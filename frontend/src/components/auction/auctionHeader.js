    ...
    return(
        <div id = {'auction-header'}>
              ...
              <section id={'auction-header-sortBy'}>
                <DropdownButton id={'auction-header-filterBy'} title={<div style={{position:'relative'}}><BsListUl style={{position:'absolute',left:'-90',fontSize:'35',top:'3.5'}}/>{CurrentToggle}</div>} className="mt-2">
