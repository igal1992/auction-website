...
import { Dropdown, ListGroup, Badge, CloseButton, Button, DropdownButton,ButtonGroup} from "react-bootstrap";
    ...
    return(
        <section className="TopNav">
            <ul id ='topNav-outer'>
                    ...
                    >
                            {cartList.length>0?
                            <Dropdown.ItemText style={{maxHeight:'500px',overflowY:'auto'}}>
                                    {cartList.map((product)=>{
                                    counter++;
                                    return(
